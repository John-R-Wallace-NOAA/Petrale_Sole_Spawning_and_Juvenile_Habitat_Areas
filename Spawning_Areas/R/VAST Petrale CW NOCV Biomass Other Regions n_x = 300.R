...
if(.Platform$OS.type == "windows") {
   load("W:\\ALL_USR\\JRW\\PacFIN & RACEBASE.R\\Main PacFIN Logbook Cleanup - 2015\\Funcs and Data\\LB.ShortForm.No.Hake.Strat 13 Apr 2017.RData")
} else {
    options(width = 150) # Linux
    load("/more_home/h_jwallace/Petrale CW NOCV Biomass n_x = 100/LB.ShortForm.No.Hake.Strat 22 Mar 2017.RData") 
