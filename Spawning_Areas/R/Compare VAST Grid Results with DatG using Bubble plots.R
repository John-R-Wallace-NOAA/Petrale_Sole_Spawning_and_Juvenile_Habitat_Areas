...
save(Petrale.Results.Dpth.Rst, 
 file = "W:/ALL_USR/JRW/Assessment/Petrale - Melissa/Org. Files Nov 2017, 2015 Data/2 - Run VAST Model/Petrale CW NOCV Biomass Regions n_x = 300/2018-01-03_Petrale_CW_NOCV_Winter_Other_nx=300/Petrale.Results.Dpth.Rst.dmp")
save(Petrale.Results.Biomass.Stacked.Dpth.Rst, 
 file = "W:/ALL_USR/JRW/Assessment/Petrale - Melissa/Org. Files Nov 2017, 2015 Data/2 - Run VAST Model/Petrale CW NOCV Biomass Regions n_x = 300/2018-01-03_Petrale_CW_NOCV_Winter_Other_nx=300/Petrale.Results.Biomass.Stacked.Dpth.Rst.dmp")

 
 #####  Find the quantiles  #####

# load("W:\\ALL_USR\\JRW\\Assessment\\Petrale - Melissa\\Org. Files Nov 2017, 2015 Data\\2 - Run VAST Model\\Petrale CW NOCV Biomass Regions n_x = 300\\Petrale.Results.Dpth.Rst.dmp")
# load("W:\\ALL_USR\\JRW\\Assessment\\Petrale - Melissa\\Org. Files Nov 2017, 2015 Data\\2 - Run VAST Model\\Petrale CW NOCV Biomass Regions n_x = 300\\Petrale.Results.Biomass.Stacked.Dpth.Rst.dmp") 

# Copy of files here: 
# load("W:/ALL_USR/JRW/Assessment/Petrale - Melissa/Org. Files Nov 2017, 2015 Data/2 - Run VAST Model/Petrale CW NOCV Biomass Regions n_x = 300/2018-01-03_Petrale_CW_NOCV_Winter_Other_nx=300/Petrale.Results.Dpth.Rst.dmp") 
# load("W:/ALL_USR/JRW/Assessment/Petrale - Melissa/Org. Files Nov 2017, 2015 Data/2 - Run VAST Model/Petrale CW NOCV Biomass Regions n_x = 300/2018-01-03_Petrale_CW_NOCV_Winter_Other_nx=300/Petrale.Results.Biomass.Stacked.Dpth.Rst.dmp") 
...
# save(Petrale.Quant.Biomass.Dpth.Rst, file = "Petrale.Quant.Biomass.Dpth.Rst.dmp")
...
# save(Petrale.Quant.Biomass.Stacked.Dpth.Rst, file="Petrale.Quant.Biomass.Stacked.Dpth.Rst.dmp")  
...
save(Petrale.Results.Dpth.Rst, file = "Petrale.Results.Dpth.Rst.dmp")
save(Petrale.Results.Biomass.Stacked.Dpth.Rst, file = "Petrale.Results.Biomass.Stacked.Dpth.Rst.dmp")
save(Top.Areas.80.by.Year.at.Least.40prct.of.Years.Dpth.Rst, file = "Top.Areas.80.by.Year.at.Least.40prct.of.Years.Dpth.Rst.dmp")
    
# ======================= Plot against Raw Data in DatG!!!!!!!!!!!!!!!!!!!!!!!!!!! =====================================

# Load New DatG with more depth restrictions
# load("W:\\ALL_USR\\JRW\\Assessment\\Petrale - Melissa\\Org. Files Nov 2017, 2015 Data\\2 - Run VAST Model\\Petrale CW NOCV Biomass Regions n_x = 300\\Petrale.Results.Dpth.Rst.dmp")
load("W:\\ALL_USR\\JRW\\Assessment\\Petrale - Melissa\\Org. Files Nov 2017, 2015 Data\\2 - Run VAST Model\\Petrale CW NOCV Biomass n_x = 300\\Petrale.Results.Dpth.Rst.dmp")
load("W:\\ALL_USR\\JRW\\Assessment\\Petrale - Melissa\\Org. Files Nov 2017, 2015 Data\\2 - Run VAST Model\\Petrale CW NOCV Biomass n_x = 300\\Petrale.Results.Biomass.Stacked.Dpth.Rst.dmp")
load("W:\\ALL_USR\\JRW\\Assessment\\Petrale - Melissa\\Org. Files Nov 2017, 2015 Data\\2 - Run VAST Model\\Petrale CW NOCV Biomass n_x = 300\\Top.Areas.80.by.Year.at.Least.40prct.of.Years.Dpth.Rst.dmp")
